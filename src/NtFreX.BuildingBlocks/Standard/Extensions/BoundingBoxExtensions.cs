...
public static class BoundingBoxExtensions
{
    ...
    public static unsafe BoundingBox TransformBoundingBox(this in BoundingBox box, in Transform transform)
        => box.TransformBoundingBox(transform.Rotation, transform.Scale, transform.Position);
    public static unsafe BoundingBox TransformBoundingBox(this in BoundingBox box, in Matrix4x4 rotation, in Vector3 scale, in Vector3 position)
    {
