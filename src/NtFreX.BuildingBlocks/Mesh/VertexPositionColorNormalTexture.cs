...
public struct VertexPositionColorNormalTexture : IVertex, IEquatable<VertexPositionColorNormalTexture>
{
    ...
    public unsafe static VertexPositionColorNormalTexture Build(byte[] data, VertexLayoutDescription layout)
    {
        ...
        return new VertexPositionColorNormalTexture(position, color, textureCoordinate, normal);
    }
